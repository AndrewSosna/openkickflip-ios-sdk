...
- (NSString *) masterString {
    ...
    if (UIInterfaceOrientationIsPortrait([UIApplication sharedApplication].statusBarOrientation)) {
        videoWidth = [OpenKickflip resolutionHeight];
        videoHeight = [OpenKickflip resolutionWidth];
    } else {
        videoWidth = [OpenKickflip resolutionWidth];
        videoHeight = [OpenKickflip resolutionHeight];
    }
